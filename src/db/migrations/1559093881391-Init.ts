...
export class Init1559093881391 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "orphans_likes" ("created_at" datetime NOT NULL, "reference_id" text NOT NULL, "sender_address" text NOT NULL, "parent_sender_address" text NOT NULL, PRIMARY KEY ("reference_id", "sender_address", "parent_sender_address"))`)
        ...
        await queryRunner.query(`CREATE TABLE "orphans_comments_reborks" ("created_at" datetime NOT NULL, "reference_id" text NOT NULL, "post_txid" text PRIMARY KEY NOT NULL, "parent_sender_address" text, CONSTRAINT "REL_3914843acb0dada1f310738fc3" UNIQUE ("post_txid"))`)
        await queryRunner.query(`CREATE INDEX "IDX_0b582965e60be13e9841022648" ON "orphans_comments_reborks" ("reference_id") `)
        await queryRunner.query(`CREATE INDEX "IDX_05c3c128901daf56927e1a3063" ON "orphans_comments_reborks" ("parent_sender_address") `)
        ...
        await queryRunner.query(`CREATE INDEX "IDX_a56e2db14676f90be1694e2723" ON "posts" ("parent_txid") `)
        await queryRunner.query(`CREATE INDEX "IDX_565d3e71ac2ea22a54a0631994" ON "posts" ("sender_address") `)
        await queryRunner.query(`CREATE TABLE "temporary_orphans_likes" ("created_at" datetime NOT NULL, "reference_id" text NOT NULL, "sender_address" text NOT NULL, "parent_sender_address" text NOT NULL, CONSTRAINT "FK_ec6fe0c0d0e6504b3064ac0db5b" FOREIGN KEY ("sender_address") REFERENCES "users" ("address"), CONSTRAINT "FK_c16bad6571f518db96b9a9ee126" FOREIGN KEY ("parent_sender_address") REFERENCES "users" ("address"), PRIMARY KEY ("reference_id", "sender_address", "parent_sender_address"))`)
        await queryRunner.query(`INSERT INTO "temporary_orphans_likes"("created_at", "reference_id", "sender_address", "parent_sender_address") SELECT "created_at", "reference_id", "sender_address", "parent_sender_address" FROM "orphans_likes"`)
        await queryRunner.query(`DROP TABLE "orphans_likes"`)
        await queryRunner.query(`ALTER TABLE "temporary_orphans_likes" RENAME TO "orphans_likes"`)
        await queryRunner.query(`DROP INDEX "IDX_0b582965e60be13e9841022648"`)
        await queryRunner.query(`DROP INDEX "IDX_05c3c128901daf56927e1a3063"`)
        await queryRunner.query(`CREATE TABLE "temporary_orphans_comments_reborks" ("created_at" datetime NOT NULL, "reference_id" text NOT NULL, "post_txid" text PRIMARY KEY NOT NULL, "parent_sender_address" text, CONSTRAINT "REL_3914843acb0dada1f310738fc3" UNIQUE ("post_txid"), CONSTRAINT "FK_3914843acb0dada1f310738fc36" FOREIGN KEY ("post_txid") REFERENCES "posts" ("txid"), CONSTRAINT "FK_05c3c128901daf56927e1a30634" FOREIGN KEY ("parent_sender_address") REFERENCES "users" ("address"))`)
        await queryRunner.query(`INSERT INTO "temporary_orphans_comments_reborks"("created_at", "reference_id", "post_txid", "parent_sender_address") SELECT "created_at", "reference_id", "post_txid", "parent_sender_address" FROM "orphans_comments_reborks"`)
        await queryRunner.query(`DROP TABLE "orphans_comments_reborks"`)
        await queryRunner.query(`ALTER TABLE "temporary_orphans_comments_reborks" RENAME TO "orphans_comments_reborks"`)
        await queryRunner.query(`CREATE INDEX "IDX_0b582965e60be13e9841022648" ON "orphans_comments_reborks" ("reference_id") `)
        await queryRunner.query(`CREATE INDEX "IDX_05c3c128901daf56927e1a3063" ON "orphans_comments_reborks" ("parent_sender_address") `)
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_05c3c128901daf56927e1a3063"`)
        await queryRunner.query(`DROP INDEX "IDX_0b582965e60be13e9841022648"`)
        await queryRunner.query(`ALTER TABLE "orphans_comments_reborks" RENAME TO "temporary_orphans_comments_reborks"`)
        await queryRunner.query(`CREATE TABLE "orphans_comments_reborks" ("created_at" datetime NOT NULL, "reference_id" text NOT NULL, "post_txid" text PRIMARY KEY NOT NULL, "parent_sender_address" text, CONSTRAINT "REL_3914843acb0dada1f310738fc3" UNIQUE ("post_txid"))`)
        await queryRunner.query(`INSERT INTO "orphans_comments_reborks"("created_at", "reference_id", "post_txid", "parent_sender_address") SELECT "created_at", "reference_id", "post_txid", "parent_sender_address" FROM "temporary_orphans_comments_reborks"`)
        await queryRunner.query(`DROP TABLE "temporary_orphans_comments_reborks"`)
        await queryRunner.query(`CREATE INDEX "IDX_05c3c128901daf56927e1a3063" ON "orphans_comments_reborks" ("parent_sender_address") `)
        await queryRunner.query(`CREATE INDEX "IDX_0b582965e60be13e9841022648" ON "orphans_comments_reborks" ("reference_id") `)
        await queryRunner.query(`ALTER TABLE "orphans_likes" RENAME TO "temporary_orphans_likes"`)
        await queryRunner.query(`CREATE TABLE "orphans_likes" ("created_at" datetime NOT NULL, "reference_id" text NOT NULL, "sender_address" text NOT NULL, "parent_sender_address" text NOT NULL, PRIMARY KEY ("reference_id", "sender_address", "parent_sender_address"))`)
        await queryRunner.query(`INSERT INTO "orphans_likes"("created_at", "reference_id", "sender_address", "parent_sender_address") SELECT "created_at", "reference_id", "sender_address", "parent_sender_address" FROM "temporary_orphans_likes"`)
        await queryRunner.query(`DROP TABLE "temporary_orphans_likes"`)
        await queryRunner.query(`DROP INDEX "IDX_565d3e71ac2ea22a54a0631994"`)
        await queryRunner.query(`DROP INDEX "IDX_a56e2db14676f90be1694e2723"`)
        await queryRunner.query(`DROP INDEX "IDX_560752d45d78a3332853345e32"`)
        await queryRunner.query(`DROP INDEX "IDX_30529cebbe83139b966d29a2b6"`)
