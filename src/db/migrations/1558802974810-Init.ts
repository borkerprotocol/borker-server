...
export class Init1558802974810 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "orphans" ("created_at" datetime NOT NULL, "parent_nonce" integer NOT NULL, "skip" integer NOT NULL, "post_txid" text PRIMARY KEY NOT NULL, "parent_sender_address" text, CONSTRAINT "REL_3a17802e46b621d371abf897ba" UNIQUE ("post_txid"))`)
        ...
        await queryRunner.query(`CREATE TABLE "temporary_orphans" ("created_at" datetime NOT NULL, "parent_nonce" integer NOT NULL, "skip" integer NOT NULL, "post_txid" text PRIMARY KEY NOT NULL, "parent_sender_address" text, CONSTRAINT "REL_3a17802e46b621d371abf897ba" UNIQUE ("post_txid"), CONSTRAINT "FK_3a17802e46b621d371abf897ba3" FOREIGN KEY ("post_txid") REFERENCES "posts" ("txid"), CONSTRAINT "FK_cdffb391974a81275700c396e19" FOREIGN KEY ("parent_sender_address") REFERENCES "users" ("address"))`)
        await queryRunner.query(`INSERT INTO "temporary_orphans"("created_at", "parent_nonce", "skip", "post_txid", "parent_sender_address") SELECT "created_at", "parent_nonce", "skip", "post_txid", "parent_sender_address" FROM "orphans"`)
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "orphans" ("created_at" datetime NOT NULL, "parent_nonce" integer NOT NULL, "skip" integer NOT NULL, "post_txid" text PRIMARY KEY NOT NULL, "parent_sender_address" text, CONSTRAINT "REL_3a17802e46b621d371abf897ba" UNIQUE ("post_txid"))`)
        await queryRunner.query(`INSERT INTO "orphans"("created_at", "parent_nonce", "skip", "post_txid", "parent_sender_address") SELECT "created_at", "parent_nonce", "skip", "post_txid", "parent_sender_address" FROM "temporary_orphans"`)
