...
export class Init1559511843093 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "orphans" ("txid" text PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL, "nonce" integer, "position" integer, "type" text NOT NULL, "content" text, "reference_id" text, "reference_sender_address" text, "mentions" text, "sender_address" text)`)
        ...
        await queryRunner.query(`CREATE TABLE "temporary_orphans" ("txid" text PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL, "nonce" integer, "position" integer, "type" text NOT NULL, "content" text, "reference_id" text, "reference_sender_address" text, "mentions" text, "sender_address" text, CONSTRAINT "FK_d8dc419b6ee03babf580a7b3c30" FOREIGN KEY ("sender_address") REFERENCES "users" ("address"))`)
        await queryRunner.query(`INSERT INTO "temporary_orphans"("txid", "created_at", "nonce", "position", "type", "content", "reference_id", "reference_sender_address", "mentions", "sender_address") SELECT "txid", "created_at", "nonce", "position", "type", "content", "reference_id", "reference_sender_address", "mentions", "sender_address" FROM "orphans"`)
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "orphans" ("txid" text PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL, "nonce" integer, "position" integer, "type" text NOT NULL, "content" text, "reference_id" text, "reference_sender_address" text, "mentions" text, "sender_address" text)`)
        await queryRunner.query(`INSERT INTO "orphans"("txid", "created_at", "nonce", "position", "type", "content", "reference_id", "reference_sender_address", "mentions", "sender_address") SELECT "txid", "created_at", "nonce", "position", "type", "content", "reference_id", "reference_sender_address", "mentions", "sender_address" FROM "temporary_orphans"`)
